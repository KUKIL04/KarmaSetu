...
import { Loader2, Building2, ShieldCheck, Copy, Check, Mail, Phone, Lock, User, Globe, Palette, Image as ImageIcon, Calendar, ArrowRight, ArrowLeft } from 'lucide-react';
                  ...
                  <div>
                    ...
                    <div className="flex space-x-3 group relative">
                      ...
                      <input 
                        ...
                        className="h-[52px] w-16 rounded-2xl cursor-pointer embossed-input p-1.5 pl-12 shrink-0"
                      />
                      <input 
                        type="text" 
                        name="themeColor" 
